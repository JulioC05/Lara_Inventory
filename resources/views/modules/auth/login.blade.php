      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card px-sm-6 px-0">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">La Económica</span>
                </a>
              </div>
              <!-- /Logo -->
              {{-- <h4 class="mb-1">La Economica</h4> --}}
            ...
            <input type="email" name="email" id="bs-validation-email" class="form-control" placeholder="Ingrese su correo" required />
