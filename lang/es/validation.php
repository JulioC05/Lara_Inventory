...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña ingresada ha sido filtrada en una brecha de datos. Por favor elige una diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes mapear los nombres de tus campos de la BD/Formulario a
    | nombres legibles en español (en lugar de ver "new_password" verás "nueva contraseña").
    |
    */
