(() => {
  ...
  (e = [].slice.call(document.querySelectorAll(".flatpickr-validation"))) && e.forEach(e => {
    e.flatpickr({allowInput: true, monthSelectorType: "static"});
  });
...
})(), document.addEventListener("DOMContentLoaded", function (e) {
  {
    ...
    }}), submitButton: new FormValidation.plugins.SubmitButton, defaultSubmit: new FormValidation.plugins.DefaultSubmit, autoFocus: new FormValidation.plugins.AutoFocus}, init: e => {
    ...
    s && s.flatpickr({enableTime: false, dateFormat: "Y/m/d", onChange: function () {
      i.revalidateField("formValidationDob");
    }}), a.length && (a.wrap('<div class="position-relative"></div>'), a.select2({placeholder: "Select country", dropdownParent: a.parent()}).on("change", function () {
      i.revalidateField("formValidationSelect2");
    })), isRtl && (s = [].slice.call(document.querySelectorAll(".typeahead"))) && s.forEach(e => {
      e.setAttribute("dir", "rtl");
    }), t.typeahead({hint: !isRtl, highlight: true, minLength: 1}, {name: "tech", source: (l = ["ReactJS", "Angular", "VueJS", "Html", "Css", "Sass", "Pug", "Gulp", "Php", "Laravel", "Python", "Bootstrap", "Material Design", "NodeJS"], function (e, a) {
